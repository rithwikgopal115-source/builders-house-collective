...
const Index = () => {
  ...
  return (
    <div className="bh-root">
      ...
      {/* ── INTRO VIDEO ──────────────────────────────────────────────  */}
      {/* ══════════════════════════════════════════════════════════════ */}
      <section style={{ padding: "32px 24px 0", maxWidth: 780, margin: "0 auto" }}>
        <button
          ...
          style={{
            ...
            borderRadius: videoOpen ? "12px 12px 0 0" : 12,
            padding: "10px 18px", width: "100%", cursor: "pointer",
            transition: "border-radius 0.2s",
          }}
        >
          <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 28, height: 28, borderRadius: "50%", background: "#E8734A", flexShrink: 0 }}>
            <svg width="11" height="13" viewBox="0 0 11 13" fill="none"><path d="M1 1L10 6.5L1 12V1Z" fill="#0D0D0D"/></svg>
          </span>
          <span style={{ flex: 1, textAlign: "left", fontSize: 13, fontWeight: 500, color: "#F5F0EB", letterSpacing: "-0.01em" }}>
            what is builders house?
          </span>
          <span style={{ fontSize: 11, fontFamily: "monospace", textTransform: "uppercase", letterSpacing: "0.08em", color: "#8A8480" }}>
            3 min · {videoOpen ? "hide ▲" : "watch ▼"}
          </span>
        </button>
        {videoOpen && (
          <div style={{ borderRadius: "0 0 12px 12px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.10)", borderTop: "none", background: "#0D0D0D" }}>
